    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-md bg-stone-900 border border-amber-500/30 rounded-2xl p-6 text-stone-100 shadow-2xl overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center mb-5">
          <div className="relative w-20 h-20 rounded-[22px] overflow-hidden border border-stone-800 shadow-2xl mb-3 bg-black flex items-center justify-center p-3 ring-1 ring-amber-400/30">
            <LogoImage
              src={iconToUse}
          ...
          <h3 className="font-serif text-lg font-bold tracking-wide text-stone-100">
            Installer l'Application WISDOM
          </h3>
          <p className="text-xs font-mono text-amber-400">
            Sur votre Bureau ou Écran d'accueil
          </p>
        </div>
        ...
        {isInstalled ? (
          ...
          <div className="space-y-4">
            <p className="text-sm text-stone-300 text-center leading-relaxed font-sans">
              Ajoutez l'application <strong className="text-amber-400 font-semibold">WISDOM</strong> à l'écran d'accueil de votre téléphone ou bureau d'ordinateur pour un accès instantané en 1-clic et une expérience ultra fluide.
            </p>
            ...
            {deferredPrompt ? (
              ...
              <div className="bg-stone-950 border border-stone-800 rounded-xl p-4 space-y-3 text-xs font-sans text-stone-300">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span>1. Appuyez sur le bouton <strong>Partager</strong> <Share className="inline w-3.5 h-3.5 text-amber-400" /> en bas de votre navigateur Safari.</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-stone-800 rounded-lg text-amber-400 shrink-0">
              ...
              <div className="bg-stone-950 border border-stone-800 rounded-xl p-4 space-y-3 text-xs font-sans text-stone-300">
                <p className="font-mono font-bold text-amber-400 uppercase text-center text-[11px]">
                  Installation sur Ordinateur & Mobile :
                </p>
                <div className="p-2.5 bg-stone-900/90 rounded-lg border border-stone-800 text-stone-300 leading-relaxed">
                  <p>
                    <strong className="text-amber-300">Sur Ordinateur (Chrome / Edge / Windows / Mac) :</strong> Cliquez sur l'icône <Download className="inline w-3.5 h-3.5 text-amber-400" /> <strong>« Installer »</strong> située tout à droite dans la barre d'adresse de votre navigateur.
                  </p>
                </div>
                <div className="p-2.5 bg-stone-900/90 rounded-lg border border-stone-800 text-stone-300 leading-relaxed">
                  <p>
                    <strong className="text-amber-300">Sur Téléphone Android :</strong> Ouvrez le menu ⋮ puis sélectionnez <strong>« Installer l'application »</strong> ou <strong>« Ajouter à l'écran d'accueil »</strong>.
                  </p>
                </div>
              </div>
            )}
